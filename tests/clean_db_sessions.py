...
from odl_ca_core.sql.graph2 import ActionModel, EndpointModel, EndpointResourceModel, FlowRuleModel, GraphModel2, MatchModel, PortModel, GraphConnectionModel 
...
session.query(GraphModel2).delete()
